...
class CoreOnlyViewController: UIViewController, MLNMapViewDelegate, ProgressChangeListener {
    ...
    private func loadRoute(map: MLNMapView, style: MLNStyle) {
        ...
        fetchRoute { directionsRoute in
            ...
            //            let navigationOptions = MapVinaNavigationOptions()
            let mlNavigation = IOSMapVinaNavigation.Builder()
    ...
    private func drawRoute(style: MLNStyle, route: DirectionsRoute) {
        ...
        // TODO (fabi755): should be done by MapVina GeoJSON library
        // But before this is possible, we need to update the MapVina native iOS one to the new KMP library
    ...
    private func enableLocationComponent(map: MLNMapView, navigation: MapVinaNavigation) {
