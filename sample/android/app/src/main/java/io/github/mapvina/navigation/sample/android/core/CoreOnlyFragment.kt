package io.github.mapvina.navigation.sample.android.core
...
import io.github.mapvina.navigation.android.navigation.ui.v5.toJvm
...
import io.github.mapvina.navigation.sample.android.databinding.FragmentCoreOnlyBinding
...
class CoreOnlyFragment : Fragment() {
    ...
    private fun loadRoute(map: MapVinaMap, style: Style) {
        ...
        lifecycleScope.launch {
            ...
            val mlNavigation = AndroidMapVinaNavigation(
    ...
    private fun enableLocationComponent(map: MapVinaMap, style: Style) {
    ...
    private fun followLocation(map: MapVinaMap) {
