Changelog for the MapVina Navigation SDK for Android
=====================================================

MapVina welcomes participation and contributions from everyone.

## Unreleased

### v5.0.0-pre12 - Dec 15, 2025

- Update MapVina native to v12.3.0
- Bump minSdk to 23 (required by MapVina 12.x)
...
- Update MapVina native to v11.12.1
...
- BREAKING CHANGES:
  - The navigation models DirectionsResponse and the classes used within this class have been moved the Mapvina-Java to the navigation-core. So the core does not need a dependency to the outdated Mapvina-Java dependency anymore.
...
- Updated Mapvina version to v10.0.2.
...
- We removed the telemetry class from the project. Nothing is being send to Mapbox or Mapvina.
