...
import com.mapvina.navigation.android.navigation.ui.v5.notification.service.NavigationNotificationService
import com.mapvina.navigation.android.navigation.ui.v5.notification.service.NavigationNotificationServiceConnection
...
class NavigationWithCustomForegroundNotificationActivity : AppCompatActivity(), OnMapReadyCallback,
    ...
    private fun startNavigationService(mapVinaNavigation: MapVinaNavigation) {
        notificationServiceConnection = NavigationNotificationServiceConnection(mapVinaNavigation, CustomNavigationNotification(this))
