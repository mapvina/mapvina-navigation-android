...
import io.github.mapvina.navigation.android.example.databinding.ActivityNavigationUiBinding
import io.github.mapvina.navigation.android.navigation.ui.v5.NavigationLauncher
import io.github.mapvina.navigation.android.navigation.ui.v5.NavigationLauncherOptions
...
class GraphHopperNavigationActivity :
    ...
    private fun calculateRoute() {
        ...
        if (io.github.mapvina.spatialk.turf.TurfMeasurement.distance(origin, destination, TurfUnit.METRES) < 50) {
            ...
            override fun onResponse(call: okhttp3.Call, response: okhttp3.Response) {
                response.use {
                    if (response.isSuccessful) {
                        ...
                        val mapvinaResponse = DirectionsResponse.fromJson(responseBodyJson);
                        this@GraphHopperNavigationActivity.route = mapvinaResponse.routes
                            .first()
                            .copy(
