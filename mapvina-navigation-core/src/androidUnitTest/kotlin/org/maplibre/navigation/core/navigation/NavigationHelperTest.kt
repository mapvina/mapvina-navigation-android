...
import com.mapvina.navigation.core.milestone.Trigger.eq
...
import com.mapvina.navigation.core.models.LegAnnotation
...
import com.mapvina.navigation.core.navigation.NavigationHelper.checkMilestones
import com.mapvina.navigation.core.navigation.NavigationHelper.createCurrentAnnotation
import com.mapvina.navigation.core.navigation.NavigationHelper.createDistancesToIntersections
import com.mapvina.navigation.core.navigation.NavigationHelper.createIntersectionsList
import com.mapvina.navigation.core.navigation.NavigationHelper.findCurrentIntersection
import com.mapvina.navigation.core.navigation.NavigationHelper.findUpcomingIntersection
import com.mapvina.navigation.core.navigation.NavigationHelper.increaseIndex
import com.mapvina.navigation.core.navigation.NavigationHelper.isUserOffRoute
import com.mapvina.navigation.core.navigation.NavigationHelper.nextManeuverPosition
import com.mapvina.navigation.core.navigation.NavigationHelper.stepDistanceRemaining
import com.mapvina.navigation.core.routeprogress.CurrentLegAnnotation
import com.mapvina.navigation.core.routeprogress.RouteLegProgress
import com.mapvina.navigation.core.routeprogress.RouteProgress
import com.mapvina.navigation.core.routeprogress.RouteStepProgress
...
class NavigationHelperTest : BaseTest() {
    ...
    fun checkMilestones_onlyTriggeredMilestonesGetReturned() {
        val routeProgress = buildMultiLegRouteProgress()
        val options = MapVinaNavigationOptions(defaultMilestonesEnabled = false)
        val mapVinaNavigation = MapVinaNavigation(options, locationEngine = mockk())
        mapVinaNavigation.addMilestone(
        ...
        val triggeredMilestones = checkMilestones(
            routeProgress,
            routeProgress, mapVinaNavigation
        )
    ...
    fun offRouteDetectionDisabled_isOffRouteReturnsFalse() {
        val options = MapVinaNavigationOptions(enableOffRouteDetection = false)
        val mapVinaNavigation = MapVinaNavigation(options = options, locationEngine = mockk())

        val userOffRoute = isUserOffRoute(mapVinaNavigation, mockk(), mockk(), mockk())
