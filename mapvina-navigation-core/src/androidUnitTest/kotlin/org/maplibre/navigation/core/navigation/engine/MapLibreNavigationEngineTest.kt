...
class MapVinaNavigationEngineTest : BaseTest() {
    ...
    private lateinit var mapVinaNavigation: MapVinaNavigation
    private lateinit var navigationEngine: MapVinaNavigationEngine
    ...
    fun setUp() {
        ...
        mapVinaNavigation = MapVinaNavigation(options = options, locationEngine = mockLocationEngine)
        navigationEngine = MapVinaNavigationEngine(
    ...
    fun triggerManualRouteUpdate_withValidLocation_callsSetIndexDirectly() = testScope.runTest {
        ...
        mapVinaNavigation.addProgressChangeListener(object : ProgressChangeListener {
        ...
        mapVinaNavigation.startNavigation(buildTestDirectionsRoute())
