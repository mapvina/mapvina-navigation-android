...
import io.github.mapvina.navigation.core.milestone.VoiceInstructionMilestone
import io.github.mapvina.navigation.core.models.DirectionsRoute
import io.github.mapvina.navigation.core.navigation.NavigationConstants.BANNER_INSTRUCTION_MILESTONE_ID
import io.github.mapvina.navigation.core.navigation.NavigationConstants.VOICE_INSTRUCTION_MILESTONE_ID
...
import io.github.mapvina.navigation.core.navigation.engine.MapVinaNavigationEngine
import io.github.mapvina.navigation.core.navigation.engine.NavigationEngine
...
import io.github.mapvina.navigation.core.route.FasterRouteListener
...
import io.github.mapvina.navigation.core.utils.ValidationUtils
import kotlin.jvm.JvmOverloads

/**
 * A MapVinaNavigation class for interacting with and customizing a navigation session.
 *
 * Instance of this class are used to setup, customize, start, and end a navigation session.
 * Building a custom
 * [MapVinaNavigationOptions] object and passing it in allows you to further customize the
 ...
 * @param options               a custom built `MapVinaNavigationOptions` class
 ...
 *
 * @see MapVinaNavigationOptions
 */
open class MapVinaNavigation @JvmOverloads constructor(
    val options: MapVinaNavigationOptions = MapVinaNavigationOptions(),
    /**
    ...
    internal constructor(
        ...
        mapVinaNavigationEngine: MapVinaNavigationEngine
    ) : this(
        options,
        locationEngine,
        cameraEngine,
        ...
        this.mapVinaNavigationEngine = mapVinaNavigationEngine
    }

    private val navigationRunnerJob = Job()
    private var mapVinaNavigationEngine: NavigationEngine? = null
        set(value) {
     ...
     * [MapVinaNavigationOptions.defaultMilestonesEnabled] is set to false but they can also
    ...
    fun startNavigation(directionsRoute: DirectionsRoute) {
        ...
        Logger.d { "MapVinaNavigation startNavigation called." }
     ...
     * user arrives unless you set [MapVinaNavigationOptions.manuallyEndNavigationUponCompletion]
     * to true.
     *
     *
     ...
     */
    fun stopNavigation() {
        Logger.d { "MapVinaNavigation stopNavigation called" }
     ...
     * `this` MapVinaNavigation instance by the constructor. This would cause memory leaks.
    ...
    private fun getNavigationEngineInternal(): NavigationEngine {
        if (mapVinaNavigationEngine == null) {
            mapVinaNavigationEngine = MapVinaNavigationEngine(
                mapVinaNavigation = this,
                routeUtils = routeUtils,
                backgroundScope = CoroutineScope(Dispatchers.Default + navigationRunnerJob)
            )
        }

        return mapVinaNavigationEngine!!
     ...
     * route and the specified criteria's in [MapVinaNavigationOptions] have been met.
     *
     *
