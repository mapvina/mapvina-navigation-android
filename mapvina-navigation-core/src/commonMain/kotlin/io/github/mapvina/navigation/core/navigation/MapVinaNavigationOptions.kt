...
/**
 * Immutable and can't be changed after passing into [MapVinaNavigation].
 */
data class MapVinaNavigationOptions(
    /**
     ...
     * for a faster [io.github.mapvina.navigation.core.models.DirectionsRoute].
     */
    ...
    class Builder {
        ...
        fun build(): MapVinaNavigationOptions {
            return MapVinaNavigationOptions(
