...
import com.mapvina.navigation.core.models.MaxSpeed
...
data class CurrentLegAnnotation(
     ...
     * [com.mapvina.navigation.core.models].
     *
     * @since 0.13.0
     */
    val index: Int,
    ...
    /**
     * Distance along the [com.mapvina.navigation.core.models.RouteLeg] that adds
