...
class OffRouteDetectorTest : BaseTest() {
    ...
    private val defaultOptions = MapVinaNavigationOptions()
    ...
    fun validOffRoute_onMinimumDistanceBeforeReroutingPassed() {
        ...
        val mapVinaNavigationOptions = MapVinaNavigationOptions()
        ...
        val target = buildPointAwayFromLocation(
            mapboxOffice,
            mapVinaNavigationOptions.offRouteMinimumDistanceMetersBeforeWrongDirection + 1
        )
