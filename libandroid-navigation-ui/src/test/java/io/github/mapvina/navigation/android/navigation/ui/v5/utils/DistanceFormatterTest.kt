package io.github.mapvina.navigation.android.navigation.ui.v5.utils
...
class DistanceFormatterTest {
    ...
    fun formatDistance_noLocaleCountry() {
        assertOutput(
            ...
            UnitType.IMPERIAL,
            MapVinaNavigationOptions.RoundingIncrement.ROUNDING_INCREMENT_FIFTY,
            "11 mi"
        )
    }
    ...
    fun formatDistance_smallFeet_roundToTen() {
        assertOutput(
            ...
            Locale.US,
            UnitType.IMPERIAL,
            MapVinaNavigationOptions.RoundingIncrement.ROUNDING_INCREMENT_TEN,
            "40 ft"
        )
    }
    ...
    private fun assertOutput(
        ...
        locale: Locale,
        unitType: UnitType,
        roundIncrement: MapVinaNavigationOptions.RoundingIncrement,
        output: String
    ) {
        Assert.assertEquals(
            output,
