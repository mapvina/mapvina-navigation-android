...
import static io.github.mapvina.spatialk.geojson.common.CommonExtKt.toJvm;
...
import io.github.mapvina.navigation.core.models.DirectionsWaypoint;
...
public class NavigationViewRouterTest extends BaseTest {
    ...
    public void findRouteFrom_fastConnectionGoesToOnline() {
        MapVinaRouteFetcher onlineRouter = mock(MapVinaRouteFetcher.class);
    ...
    private NavigationViewRouter buildRouteEngine(ViewRouteListener routeEngineListener) {
        return new NavigationViewRouter(mock(MapVinaRouteFetcher.class), mock(ConnectivityStatusProvider.class),
            routeEngineListener);
    }
