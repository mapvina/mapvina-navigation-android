...
public class NavigationMapVinaMapTest {
  ...
  public void updateIncidentsVisibility_layerIdentifierIsClosures() {
    ...
    NavigationMapVinaMap theNavigationMap = new NavigationMapVinaMap(mockedMapLayerInteractor);
  ...
  public void updateRenderMode_locationComponentIsUpdatedWithRenderMode() {
    ...
    NavigationMapVinaMap theNavigationMap = new NavigationMapVinaMap(locationComponent);
  ...
  public void drawRoutes_mapRoutesAreAdded() {
    ...
    NavigationMapVinaMap theNavigationMap = new NavigationMapVinaMap(mapRoute);
  ...
  public void addOnWayNameChangedListener_listenerIsAddedToMapWayname() {
    ...
    NavigationMapVinaMap theNavigationMap = new NavigationMapVinaMap(mapWayName, mapFpsDelegate);
  ...
  public void onInitializeWayName_existingV7StreetSourceIsUsed() {
    ...
    new NavigationMapVinaMap(mapVinaMap, layerInteractor, adjustor);
  ...
  public void addDestinationMarker_navigationSymbolManagerReceivesPosition() {
    ...
    NavigationMapVinaMap map = new NavigationMapVinaMap(navigationSymbolManager);
