...
class TimeFormatterTest {
    ...
    fun checksTwelveHoursTimeFormat() {
        ...
        val twelveHoursTimeFormatType = MapVinaNavigationOptions.TimeFormat.TWELVE_HOURS
    ...
    fun checksTwentyFourHoursTimeFormat() {
        ...
        time[anyYear, anyMonth, anyDay, sixPm, eighteenMinutes] = zeroSeconds
        val elevenMinutes = 663.7
        val twentyFourHoursTimeFormatType = MapVinaNavigationOptions.TimeFormat.TWENTY_FOUR_HOURS
    ...
    fun checksDefaultTwelveHoursTimeFormat() {
        ...
        time[anyYear, anyMonth, anyDay, sixPm, eighteenMinutes] = zeroSeconds
        val elevenMinutes = 663.7
        val noneSpecifiedTimeFormatType = MapVinaNavigationOptions.TimeFormat.NONE_SPECIFIED
