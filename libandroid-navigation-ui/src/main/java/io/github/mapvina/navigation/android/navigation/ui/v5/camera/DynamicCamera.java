...
public class DynamicCamera extends SimpleCamera {
  ...
  public DynamicCamera(@NonNull MapVinaMap mapVinaMap) {
  ...
  public double zoom(RouteInformation routeInformation) {
    ...
    return mapVinaMap.getCameraPosition().zoom;
  }
  ...
  /**
   * Creates a zoom value based on the result of {@link MapVinaMap#getCameraForLatLngBounds(LatLngBounds, int[])}.
   * <p>
   ...
   * <p>
   * Using {@link MapVinaMap#getCameraForLatLngBounds(LatLngBounds, int[])} with a {@link LatLngBounds}
  ...
  private CameraPosition createCameraPosition(Location location, RouteProgress routeProgress) {
    ...
    if (upComingStep != null) {
      ...
      if (latLngs.size() < 1 || currentLatLng.equals(maneuverLatLng)) {
        return mapVinaMap.getCameraPosition();
      }
      ...
      int[] padding = {0, 0, 0, 0};
      return mapVinaMap.getCameraForLatLngBounds(cameraBounds, padding);
    }
    return mapVinaMap.getCameraPosition();
  }
