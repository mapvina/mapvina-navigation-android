...
import io.github.mapvina.navigation.android.navigation.ui.v5.instruction.ImageCreator;
import io.github.mapvina.navigation.android.navigation.ui.v5.instruction.NavigationAlertView;
import io.github.mapvina.navigation.android.navigation.ui.v5.map.NavigationMapVinaMap;
import io.github.mapvina.navigation.android.navigation.ui.v5.map.NavigationMapVinaMapInstanceState;
import io.github.mapvina.navigation.android.navigation.ui.v5.map.WayNameView;
import io.github.mapvina.navigation.android.navigation.ui.v5.summary.SummaryBottomSheet;
...
import io.github.mapvina.navigation.android.navigation.ui.v5.instruction.InstructionView;
...
import io.github.mapvina.navigation.android.navigation.ui.v5.utils.LocaleUtils;
...
public class NavigationView extends CoordinatorLayout implements LifecycleOwner, OnMapReadyCallback,
  ...
  private NavigationMapVinaMap navigationMap;
  ...
  private NavigationMapVinaMapInstanceState mapInstanceState;
   ...
   *
   * @param mapVinaMap used for route, camera, and location UI
   * @since 0.6.0
   */
  @Override
  public void onMapReady(final MapVinaMap mapVinaMap) {
    mapVinaMap.setStyle(ThemeSwitcher.retrieveMapStyle(getContext()), new Style.OnStyleLoaded() {
      @Override
      public void onStyleLoaded(@NonNull Style style) {
        initializeNavigationMap(mapView, mapVinaMap);
   ...
   * {@link NavigationMapVinaMap#updateWaynameQueryMap(boolean)}.
   *
   ...
   * <p>
   * The {@link NavigationMapVinaMap} gives direct access to the map UI (location marker, route, etc.).
   *
   * @return navigation MapVina map object, or null if view has not been initialized
   */
  @Nullable
  public NavigationMapVinaMap retrieveNavigationmapVinaMap() {
    return navigationMap;
  }

  /**
   * Returns the instance of {@link MapVinaNavigation} powering the {@link NavigationView}
   ...
   *
   * @return MapVina navigation, or null if navigation has not started
   */
  @Nullable
  public MapVinaNavigation retrieveMapVinaNavigation() {
  ...
  private void initializeNavigationMap(MapView mapView, MapVinaMap map) {
    if (initialMapCameraPosition != null) {
      map.setCameraPosition(initialMapCameraPosition);
    }
    navigationMap = new NavigationMapVinaMap(mapView, map);
  ...
  private void initializeNavigation(NavigationViewOptions options) {
    ...
    setupNavigationmapVinaMap(options);
  ...
  private void establishDistanceFormatter(LocaleUtils localeUtils, NavigationViewOptions options) {
    ...
    MapVinaNavigationOptions.RoundingIncrement roundingIncrement = establishRoundingIncrement(options);
  ...
  private MapVinaNavigationOptions.RoundingIncrement establishRoundingIncrement(NavigationViewOptions navigationViewOptions) {
    MapVinaNavigationOptions mapVinaNavigationOptions = navigationViewOptions.navigationOptions();
    return mapVinaNavigationOptions.getRoundingIncrement();
  }
  ...
  private void setupNavigationmapVinaMap(NavigationViewOptions options) {
