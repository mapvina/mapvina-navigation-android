...
import io.github.mapvina.navigation.android.navigation.ui.v5.utils.time.TimeFormatter
...
import io.github.mapvina.navigation.android.navigation.ui.v5.utils.ManeuverUtils
import java.util.Calendar

/**
 * This is in charge of creating the persistent navigation session notification and updating it.
 */
open class MapVinaNavigationNotification(
    context: Context,
    ...
    private val distanceFormatter: DistanceFormatter = initializeDistanceFormatter(context, mapVinaNavigation)
    ...
    private val endNavigationBtnReceiver: BroadcastReceiver = object : BroadcastReceiver() {
        override fun onReceive(context: Context, intent: Intent) {
            this@MapVinaNavigationNotification.onEndNavigationBtnClick()
        }
    }
    ...
    private fun initializeDistanceFormatter(
        ...
        val routeOptions = mapVinaNavigation.route?.routeOptions
        ...
        return DistanceFormatter(
            ...
            language,
            unitType,
            mapVinaNavigation.options.roundingIncrement
        )
    }
    ...
    private fun onEndNavigationBtnClick() {
        mapVinaNavigation.stopNavigation()
    }
