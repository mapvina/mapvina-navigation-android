 ...
 * <p>
 * Takes a {@link SpeechPlayerProvider} which will provide either a {@link MapVinaSpeechPlayer}
 * or {@link AndroidSpeechPlayer} based on the given language - if it is supported by our Voice API.
 * <p>
 * {@link MapVinaSpeechPlayer} requires Internet connectivity.  In cases where a connection is not
