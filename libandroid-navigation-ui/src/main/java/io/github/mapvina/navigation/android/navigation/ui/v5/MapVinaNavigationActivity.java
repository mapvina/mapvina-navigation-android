 ...
 */
public class MapVinaNavigationActivity extends AppCompatActivity implements OnNavigationReadyCallback, NavigationListener {
  ...
  public void onNavigationReady(boolean isRunning) {
    ...
    options.navigationOptions(new MapVinaNavigationOptions());
