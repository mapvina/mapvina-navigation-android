 ...
 * {@link MapVinaNavigation#startNavigation(DirectionsRoute)}, using this class will ensure your
...
public final class NavigationRoute {
    ...
    private Callback<com.mapbox.api.directions.v5.models.DirectionsResponse> toMapboxCallback(Callback<DirectionsResponse> callback) {
        return new Callback<>() {
            ...
            public void onResponse(Call<com.mapbox.api.directions.v5.models.DirectionsResponse> call, Response<com.mapbox.api.directions.v5.models.DirectionsResponse> response) {
                callback.onResponse(toMapVinaCall(call), toMapVinaResponse(response));
            }

            @Override
            public void onFailure(Call<com.mapbox.api.directions.v5.models.DirectionsResponse> call, Throwable t) {
                callback.onFailure(toMapVinaCall(call), t);
            }
        };
    }

    private Response<DirectionsResponse> toMapVinaResponse(Response<com.mapbox.api.directions.v5.models.DirectionsResponse> response) {
        if (response.isSuccessful()) {
            return Response.success(response.code(), toMapVinaDirectionsResponse(response.body()));
        } else {
            return Response.error(response.errorBody(), response.raw());
        }
    }

    private Call<DirectionsResponse> toMapVinaCall(Call<com.mapbox.api.directions.v5.models.DirectionsResponse> call) {
        return new Call<>() {
            @Override
            public Response<DirectionsResponse> execute() throws IOException {
                return toMapVinaResponse(call.execute());
            }
            ...
            public Call<DirectionsResponse> clone() {
                return toMapVinaCall(call.clone());
            }
    ...
    public Call<DirectionsResponse> getCall() {
        return toMapVinaCall(mapboxDirections.cloneCall());
    }
    ...
    public static final class Builder {
         ...
         *
         * @param origin a GeoJson {@link io.github.mapvina.spatialk.geojson.Point} object representing the starting location for the route
         * @return this builder for chaining options together
         * @since 0.5.0
         */
         ...
         *                 one of the {@link io.github.mapvina.navigation.core.models.RouteLeg} to
         ...
         * other fields outside of the {@link io.github.mapvina.navigation.core.models.VoiceInstructions}
         * object.
         *
    ...
    private static DirectionsResponse toMapVinaDirectionsResponse(com.mapbox.api.directions.v5.models.DirectionsResponse directionsResponse) {
