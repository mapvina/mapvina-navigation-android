...
import com.mapvina.navigation.android.navigation.ui.v5.listeners.RouteListener;
import com.mapvina.navigation.android.navigation.ui.v5.listeners.SpeechAnnouncementListener;
...
class NavigationViewEventDispatcher {
  ...
  /**
   * Initializes the listeners in the dispatcher, as well as the listeners in the {@link MapVinaNavigation}
   *
  ...
  void initializeListeners(NavigationViewOptions navigationViewOptions, NavigationViewModel navigationViewModel) {
    ...
    MapVinaNavigation navigation = navigationViewModel.retrieveNavigation();
  ...
  void onDestroy(@Nullable MapVinaNavigation navigation) {
    if (navigation != null) {
  ...
  private void assignProgressChangeListener(NavigationViewOptions navigationViewOptions, MapVinaNavigation navigation) {
  ...
  private void assignMilestoneEventListener(NavigationViewOptions navigationViewOptions, MapVinaNavigation navigation) {
  ...
  private void removeMilestoneEventListener(MapVinaNavigation navigation) {
    if (milestoneEventListener != null) {
      navigation.removeMilestoneEventListener(milestoneEventListener);
    }
  }

  private void removeProgressChangeListener(MapVinaNavigation navigation) {
    if (progressChangeListener != null) {
