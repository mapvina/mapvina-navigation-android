...
import static com.mapvina.android.style.expressions.Expression.product;
...
import static com.mapvina.android.style.layers.PropertyFactory.iconImage;
import static com.mapvina.android.style.layers.PropertyFactory.iconPitchAlignment;
import static com.mapvina.android.style.layers.PropertyFactory.iconSize;
import static com.mapvina.android.style.layers.PropertyFactory.lineCap;
import static com.mapvina.android.style.layers.PropertyFactory.lineColor;
import static com.mapvina.android.style.layers.PropertyFactory.lineJoin;
import static com.mapvina.android.style.layers.PropertyFactory.lineWidth;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.DESTINATION_MARKER_NAME;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.HEAVY_CONGESTION_VALUE;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.MODERATE_CONGESTION_VALUE;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.ORIGIN_MARKER_NAME;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.PRIMARY_ROUTE_PROPERTY_KEY;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.ROUTE_LAYER_ID;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.ROUTE_SHIELD_LAYER_ID;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.ROUTE_SOURCE_ID;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.SEVERE_CONGESTION_VALUE;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.WAYPOINT_DESTINATION_VALUE;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.WAYPOINT_LAYER_ID;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.WAYPOINT_ORIGIN_VALUE;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.WAYPOINT_PROPERTY_KEY;
import static com.mapvina.navigation.android.navigation.ui.v5.route.RouteConstants.WAYPOINT_SOURCE_ID;
