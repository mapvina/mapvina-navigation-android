...
public class MapVinaRouteFetcher extends RouteFetcher {
    ...
    private List<Point> toMapboxPointList(List<com.mapvina.spatialk.geojson.Point> pointList) {
        List<Point> mapboxPointList = new ArrayList<>();
        for (com.mapvina.spatialk.geojson.Point point : pointList) {
            mapboxPointList.add(toMapboxPoint(point));
        }
        return mapboxPointList;
    }

    private Point toMapboxPoint(com.mapvina.spatialk.geojson.Point point) {
        return Point.fromLngLat(point.getLongitude(), point.getLatitude());
    }

    private List<com.mapvina.spatialk.geojson.Point> toMapVinaPointList(List<Point> pointList) {
        List<com.mapvina.spatialk.geojson.Point> mapboxPointList = new ArrayList<>();
    ...
    private com.mapvina.spatialk.geojson.Point toMapVinaPoint(Point point) {
        return new com.mapvina.spatialk.geojson.Point(point.longitude(), point.latitude());
    }
}
